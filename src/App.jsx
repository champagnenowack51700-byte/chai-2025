          ...
          <div style={{...s.modalBox,width:"660px"}}>
            ...
            <div style={{display:"grid",gap:"14px"}}>
              ...
              <div style={{background:"#fff8ee",borderRadius:"8px",padding:"14px",border:"0.5px solid #d4c4a0"}}>
                ...
                <textarea style={{...s.inp,height:"80px",resize:"vertical",fontSize:"12px"}} placeholder={"cuvee;millesime;format;lieu;qte placeholder="cuvee;millesime;format;lieu;qte" value={clotureForm.importCsv} onChange={e=>setClotureForm(f=>({...f,importCsv:e.target.value}))}/>
